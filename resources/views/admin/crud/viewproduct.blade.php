            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td>
                    <div class="inline-flex items-center rounded-md shadow-sm">
                        <button class="text-white hover:text-slate-300 text-sm bg-blue-600 hover:bg-blue-700 text-sm border border-slate-200 rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
                            <span>
