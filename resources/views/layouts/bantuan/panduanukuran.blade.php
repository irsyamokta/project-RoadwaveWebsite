  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Panduan Ukuran</span>
      </div>
    </li>
  </ol>
</nav>
<div class="mt-10 mb-10 w-full max-w-screen-xl mx-auto">
  <!-- Tabs -->
  <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400 mt-5 px-7">
    <li class="me-2">
        <a href="/panduanukuran" aria-current="page" class="inline-block p-4 text-white bg-mainColor rounded-t-lg active dark:bg-mainColor dark:text-white">Panduan Ukuran</a>
      </li>
      <li class="me-2">
    ...
    <!-- Content -->
    <div class="px-7 py-5 mb-5">
      <h3 class="text-3xl font-semibold text-slate-700 mb-7 dark:text-slate-200 mt-5">Panduan Ukuran</h3>

      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-5 md:gap-7 md:grid-cols-3 lg:grid-cols-4">
        <div class="shadow-xl">
          <img class="h-auto max-w-full rounded-lg" src="{{url('assets/icon/sizechartTshirt.png')}}" alt="" />
        </div>
        <div class="shadow-xl">
          <img class="h-auto max-w-full rounded-lg" src="{{url('assets/icon/sizechartShirt.png')}}" alt="" />
        </div>
        <div class="shadow-xl">
          <img class="h-auto max-w-full rounded-lg" src="{{url('assets/icon/sizechartPants.png')}}" alt="" />
        </div>
        <div class="shadow-xl">
          <img class="h-auto max-w-full rounded-lg" src="{{url('assets/icon/sizechartOutwear.png')}}" alt="" />
        </div>
      </div>
    </div>
  </div>
