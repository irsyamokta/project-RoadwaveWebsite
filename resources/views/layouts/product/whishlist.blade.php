      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Wish List</span>
          </div>
        </li>
      </ol>
    </nav>
    <div class="w-full mx-auto mb-3">
      <h3 class="text-lg font-bold text-slate-700 dark:text-gray-200">My Wish List</h3>
    </div>
    <div class="px-10 md:px-14 py-5">
      <div class="mx-auto flex justify-center items-center">
        <img src="{{ asset('assets\icon\underconstruction.png') }}" width="w-full" alt="" />
      </div>
    </div>
  </main>
  <!-- End Content -->
